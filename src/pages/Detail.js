 ...
 return (
   <View style={styles.container}>
    ...
    <View style={styles.headerContent}>
      <View style={{ width: '65%' }}>
        <Text style={styles.viagem}>Rio de Janeiro</Text>
      </View>
    ...
    <Text style={styles.description}>
     Passeios de barco, visita ao Cristo Redentor, muito samba e com a melhor hospedagem da região
    </Text>

    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35 }}>
      <View style={styles.slide}>
        <Image
        source={require('../assets/viagem1.jpg')}
